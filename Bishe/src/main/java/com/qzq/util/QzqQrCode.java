...
public class QzqQrCode {
    ...
    public  void encode(String content, int width, int height,
            String iconImagePath, ServletOutputStream steam,boolean hasFiller) {
        try {
            /**
             * 图标格式校验
             */
            ...
            if(width<260||height<260){
                width = QzqQrCode.WIDTH;
                height = QzqQrCode.HEIGHT;
            }
            ImageIO.write(genBarcode(content, width, height, iconImagePath,hasFiller),
                    "png",steam);
            System.err.println("二维码已生成  ");
        } catch (IOException e) {
     ...
     * @throws IOException
     */
    private  BufferedImage scale(String iconImagePath, int height,
     ...
     * @return
     */
    private  boolean checkIMGType(String fileExtName){
        boolean flag = false;
   ...
   /* public static void main(String[] args) {
        String codeIconPath = "d://index.jpg";
        String codePath = "d://"+new Date().getTime()+".png";
        QRCode.encode("项目：晚餐定制",300, 300, codeIconPath, codePath,false);
    }*/
}